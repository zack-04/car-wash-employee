...
String interiorStandard = 'Interior Standard';
String interiorPremium = 'Interior Premium';
String pressureWashWithInterior = 'Pressure Wash with Interior';
String pressureWash = 'Pressure Wash';
