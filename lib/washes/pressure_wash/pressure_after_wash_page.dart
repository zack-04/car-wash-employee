...
class PressureAfterWashPage extends StatefulWidget {
  const PressureAfterWashPage({super.key});

  @override
  State<PressureAfterWashPage> createState() => _PressureAfterWashPageState();
}

class _PressureAfterWashPageState extends State<PressureAfterWashPage> {
